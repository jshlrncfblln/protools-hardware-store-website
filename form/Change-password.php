                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="" method="post">
                            <input type="password" class="password" name="password" placeholder="Create your new Password" required>
                            <input type="password" class="confirm-password" name="confirm-password" placeholder="Confirm your new Password" required>
